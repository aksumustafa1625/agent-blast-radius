...
ok "site: canonical str" "$(echo "$H" | grep -c 'AKSU:1.0/P:6/C:1/B:0/U:1/fp:84ae32568aac')"
...
ok "spec: current digest" "$(echo "$S" | grep -c '52c669ea07a9')"
ok "spec: stale digest"   "$(echo "$S" | grep -c 'd3a0cb4d683c')"                # want 0
