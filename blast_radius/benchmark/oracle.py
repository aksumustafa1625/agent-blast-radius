 ...
 * The analyzer predicts this field is {'READABLE past' if rt['expect_read'] else 'OUT OF REACH of'}
 * the running user. The org decides. */
public {decl}class BR_Or_{_ident(case['id'])} {{
    public String readField() {{
        try {{
            List<{_OBJECT}> r = [SELECT {_FIELD} FROM {_OBJECT}{clause} LIMIT 1];
