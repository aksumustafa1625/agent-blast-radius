...
- **[PS504] BlastRadius_E2_ReaderV58 -> Blast_Test__c**
  - Reach for this operation could not be fully determined (apiVersion<=66 system default).
...
Bound to fingerprint `f87e939a63c2`; regenerate if agent config, any analysed Apex/Flow, or permission metadata changes.