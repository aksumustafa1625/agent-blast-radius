...
- **`Blast_Test__c`** — a custom object with `Private` org-wide default
- **`Customer_IBAN__c`** — the field under test; the modelled user has **no field
  permission on it**
- **The running user** — object `READ` on `Blast_Test__c`, and deliberately nothing
...
```
corpus.json  sha256  fc274b70f7620537d7624c3764faf28ed5654e13f9bb586c2e4240e7e7f1714d
```

Per-case hashes are in [`CHECKSUMS.md`](CHECKSUMS.md). A benchmark whose author can
edit it silently is not a benchmark.
